@extends('layout.app')
@section('judul', 'Data Sumber Air Desa Mekarmukti')
@section('nav', 'data')
@section('content')
    <main id="main">
        <section class="breadcrumbs">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h2>Data Air Bersih</h2>
                    <ol>
                        <li><a href="{{route('home')}}">Beranda</a></li>
                        <li>Data Sumber Air</li>
                    </ol>
                </div>
        ...
        <section class="features">
            <div class="container">
                <div class="section-title">
                    <h2>Statistik Sumber Air Bersih Desa Mekarmukti</h2>
                ...
                <div class="penduduk">
                    <div class="container">
                        <div class="card sm:m-5">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"> Data Sumber Air Bersih</h5>
                                <p class="card-text"></p>
                                <div>
                    ...
                    <script>
                        ...
                        let Charts = new Chart(ctx, {
                            ...
                            data: {
                                labels: [],
                                datasets: [{
                                    label: 'Jumlah Pengguna Sumber Air',
                                    backgroundColor: [],
