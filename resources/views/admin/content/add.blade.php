...
<body>
    ...
    <div class="container mx-auto py-8">
        <form action="{{ route('artikel.store') }}" method="POST"
            ...
            <h1 class="text-3xl font-bold mb-6 text-center text-indigo-600">Tambah Artikel Baru</h1>
            @if ($errors->any())
            ...
            <div class="mb-6">
                ...
                <input type="text" name="judul" id="judul" value="{{ old('judul', $judul ?? '') }}"
            ...
            <div class="mb-6">
                ...
                <input type="text" name="head" id="judul" value="{{ old('head', $head ?? '') }}"
                    class="mt-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 transition-colors duration-300 ease-in-out hover:bg-gray-100">
            </div>
            <div class="mb-6">
            ...
            <div id="imageUpload" class="mb-6 hidden">
                ...
                @if (isset($imgjudul))
                    <div class="flex justify-center mt-4">
                        <img src="{{ asset('img/') . $imgjudul }}" alt="Image Preview"
            ...
            <div class="mb-6">
                <label for="content" class="block text-lg font-medium text-gray-700">Konten<span
                        class="text-red-500">*</span></label>
                <textarea name="content" id="content" rows="5"
                    class="prose mt-2 p-2 border-gray-300 rounded-md shadow-sm w-full transition-colors duration-300 ease-in-out hover:bg-gray-100">{!! old('content', $content ?? '') !!}</textarea>
            </div>
            <div class="mb-6">
                ...
                <select name="kategori" id="kategori"
                    ...
                    <option value="" {{ old('kategori') == '' ? 'selected' : '' }}>lainnya</option>
                </select>
            </div>
            <div class="mb-6">
            ...
            <div class="mb-6">
                <button type="submit"
                    class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-transform transform hover:scale-105">
                    Simpan
                </button>
            </div>
        </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const uploadYoutube = document.getElementById('uploadYoutube');
            ...
            uploadYoutube.addEventListener('change', function() {
                if (this.checked) {
