...
<div class="page-header">
    <div class="page-header-content">
        <div>
            ...
            <p class="page-subtitle">Update informasi gambar: {{ $image->nama_gambar }}</p>
        </div>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.hero-images.update', $image->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('nama_gambar', $image->nama_gambar) }}" 
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="deskripsi" 
                                  ...
                                  rows="4" 
                                  placeholder="Deskripsikan gambar hero...">{{ old('deskripsi', $image->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <small class="form-text text-muted">
                            ...
                            Angka yang lebih kecil akan tampil lebih dulu
                        </small>
                        @error('urutan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $image->is_active) ? 'checked' : '' }}>
                            <label class="form-check-label" for="is_active">
                                Aktifkan gambar ini
                            </label>
                        </div>
                        <small class="form-text text-muted">Hanya gambar aktif yang akan tampil di slideshow</small>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="upload-area" onclick="document.getElementById('gambar').click();">
                            ...
                            <img src="{{ asset($image->gambar) }}" id="preview" class="preview-image">
                            @elseif($image->gambar && file_exists(public_path('storage/' . $image->gambar)))
                            <img src="{{ asset('storage/' . $image->gambar) }}" id="preview" class="preview-image">
                            @else
                    ...
                    <div class="alert alert-success">
                        ...
                        <small>{{ basename($image->gambar) }}</small>
                    </div>
                    @endif
                    ...
                    <div class="alert alert-info">
                        ...
                        <ul class="mb-0 mt-2">
                            ...
                            <li>Ukuran optimal: 1920x1080px</li>
                        </ul>
                    </div>
                </div>
            </div>
