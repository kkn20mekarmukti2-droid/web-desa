            ...
            <div class="container" style="position: relative; z-index: 2;">
                ...
                <div class="text-center mb-5" data-aos="fade-up">
                    ...
                    <h2 class="display-5 fw-bold text-white mb-4">
                        �️ UMKM Desa Mekarmukti
                    </h2>
                    <p class="lead text-white-75 max-w-2xl mx-auto" style="color: rgba(255,255,255,0.8);">
                        Dukung ekonomi lokal dengan produk-produk unggulan dari UMKM Desa Mekarmukti
                    </p>
                    <div class="divider mx-auto mt-4" style="width: 60px; height: 4px; background: linear-gradient(90deg, #F59E0B, #D97706); border-radius: 2px;"></div>
                </div>
                ...
                <div class="row align-items-center" data-aos="fade-up" data-aos-delay="100">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        <div class="umkm-preview position-relative">
                            <div class="umkm-image-container" style="perspective: 1000px;">
                                <div class="umkm-display" style="transform: rotateY(-15deg) rotateX(5deg); transition: all 0.6s ease;">
                                    <div class="img-fluid rounded-3 shadow-lg d-flex align-items-center justify-content-center" 
                                         style="width: 100%; max-width: 400px; height: 300px; background: linear-gradient(135deg, #10b981 0%, #047857 100%);">
                                        <div class="text-center text-white">
                                            <i class="fas fa-shopping-bag fa-4x mb-3"></i>
                                            <h5>Produk UMKM Lokal</h5>
                                            <p class="mb-0">Dukung Ekonomi Desa</p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="umkm-info text-white">
                            ...
                            <p class="lead mb-4" style="color: rgba(255,255,255,0.9); line-height: 1.6;">
                                Temukan berbagai produk berkualitas dari UMKM lokal Desa Mekarmukti. Mulai dari hasil pertanian hingga kerajinan tangan yang unik.
                            </p>
                            
                            <!-- UMKM Features -->
                            <div class="umkm-features mb-4">
                                <div class="row text-center">
                                    <div class="col-4">
                                        <div class="feature-item">
                                            <h4 class="text-warning fw-bold mb-1"><i class="fas fa-seedling"></i></h4>
                                            <small class="text-white-75">Organik</small>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="feature-item">
                                            <h4 class="text-warning fw-bold mb-1"><i class="fas fa-handshake"></i></h4>
                                            <small class="text-white-75">Lokal</small>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="feature-item">
                                            <h4 class="text-warning fw-bold mb-1"><i class="fas fa-star"></i></h4>
                                            <small class="text-white-75">Berkualitas</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 pt-3 border-top" style="border-color: rgba(255,255,255,0.2) !important;">
                                <small class="text-white-75">
                                    ...
                                    Dukung ekonomi lokal dengan berbelanja produk UMKM desa
                                </small>
                            </div>
                        </div>
                    </div>
