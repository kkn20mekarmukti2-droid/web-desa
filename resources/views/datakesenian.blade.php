@extends('layout.app')
@section('judul', 'Data Kesenian Desa Mekarmukti')
@section('nav', 'data')
@section('content')
        ...
        <section class="features">
            <div class="container">
                <div class="section-title">
                    <h2>Statistik Data Kesenian Desa Mekarmukti</h2>
                ...
                <div class="penduduk">
                    <div class="container">
                        <div class="card sm:m-5">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"> Data Grup Seni</h5>
                                <p class="card-text"></p>
                                <div>
