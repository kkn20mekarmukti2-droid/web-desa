            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li><a class="{{ Request::route()->getName() == 'about' ? 'active' : '' }}"
                                href="{{ route('about') }}">Profil</a></li>
                        <li><a class="{{ Request::route()->getName() == 'pemerintahan' ? 'active' : '' }}"
                                href="{{ route('pemerintahan') }}">Pemerintahan </a></li>
                        <li class="dropdown group"><a href="#"><span
                                    class="{{ View::hasSection('nav') && View::getSection('nav') == 'data' ? 'active' : '' }}">Data
                                    Desa</span> <i
                                    class="bi bi-chevron-down group-hover:rotate-180 transition-all"></i></a>
                            <ul>
                                <li><a href="{{ route('data.penduduk') }}">Data Penduduk</a></li>
                                <li><a href="{{ route('data.kk') }}">Data KK</a></li>
                                <li><a href="{{ route('data.pendidikan') }}">Data Pendidikan</a></li>
                                <li><a href="{{ route('data.kesehatan') }}">Data Kesehatan</a></li>
                                <li><a href="{{ route('data.profesi') }}">Data Profesi</a></li>
                                <li><a href="{{ route('data.klub') }}">Data Klub Olahraga</a></li>
                                <li><a href="{{ route('data.kesenian') }}">Data Grup Kesenian</a></li>
                               
                            </ul>
                        </li>
                        <li class="dropdown group"><a href="#"><span
                                    class="{{ View::hasSection('nav') && View::getSection('nav') == 'rtrw' ? 'active' : '' }}">Data
                                    RW</span> <i
                                    class="bi bi-chevron-down group-hover:rotate-180 transition-all"></i></a>
                                <ul>
                            @foreach ($rws as $rw)
                                    <li><a href="{{ route('data.rw', ['rw' => $rw->rw]) }}">RW
                                            {{ str_pad($rw->rw, 2, '0', STR_PAD_LEFT) }}</a></li>
                            @endforeach
                                </ul>
                        </li>
